...
class ApiTestCase extends WebTestCase
{
    ...
    {
        static::$partnerHelper = new PartnerHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$broadcastListenerHelper = new BroadcastListenerHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$experienceHelper = new ExperienceHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$componentHelper = new ComponentHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$boxHelper = new BoxHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$bookingHelper = new BookingHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl,
        ...
        static::$boxExperienceHelper = new BoxExperienceHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$experienceComponentHelper = new ExperienceComponentHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$healthCheckHelper = new HealthCheckHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );

        static::$quickDataHelper = new QuickDataHelper(
            clone static::$client,
            static::$serializer,
            static::$baseUrl
        );
