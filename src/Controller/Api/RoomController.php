...
{
    /**
     * @Route("/internal/room", methods={"POST"}, format="json")
     *
     * @SWG\Tag(name="room")
     * @SWG\Parameter(
     *         name="body",
    ...
    /**
     * @Route("/internal/room/{uuid}", methods={"GET"}, format="json")
     *
     * @SWG\Tag(name="room")
     * @SWG\Parameter(
     *     name="uuid",
    ...
    /**
     * @Route("/internal/room/{uuid}", methods={"DELETE"}, format="json")
     *
     * @SWG\Tag(name="room")
     * @SWG\Parameter(
     *     name="uuid",
    ...
    /**
     * @Route("/internal/room/{uuid}", methods={"PUT"}, format="json")
     *
     * @SWG\Tag(name="room")
     * @SWG\Parameter(
     *     name="uuid",
