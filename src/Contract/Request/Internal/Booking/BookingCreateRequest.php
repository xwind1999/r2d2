...
namespace App\Contract\Request\Internal\Booking;

use App\Contract\Request\Internal\Guest\GuestRequest;
...
class BookingCreateRequest implements RequestBodyInterface, ValidatableRequest
{
     ...
     * @Assert\NotBlank
     *
     * @JMS\Type("array<App\Contract\Request\Internal\Guest\GuestRequest>")
     *
