...
namespace App\Contract\Response\Internal\Booking;
...
abstract class BookingResponse extends ResponseContract
{
    ...
    /**
     * @Assert\Type(type="array<App\Contract\Response\Internal\Guest\GuestResponse>")
     * @Assert\NotBlank
     *
     * @JMS\Type("array<App\Contract\Response\Internal\Guest\GuestResponse>")
     *
     * @var array<int, Guest>
     */
    public array $guest;
